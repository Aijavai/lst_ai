...
function App() {
  // 火山引擎tts 配置文件
  const TOKEN = 'mYDZzP7AdCaAXv_01fZzg_Nix59Sy7ii';
  const APP_ID = '2921913620';
  const CLUSTER_ID = 'volcano_tts';

  // 代码的可读性高于一切
  const [prompt, setPrompt] = useState('大家好，我是胡冠辉');
  ...
  return (
    <div className="container">
      ...
      <audio ref={audioPlayer} src="/sounds/snare.wav" autoPlay></audio>
