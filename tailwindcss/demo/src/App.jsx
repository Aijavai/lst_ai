...
function App() {
  return (
    ...
    {/* AI语义 */}
    {/* <h1 className='text-3xl font-bold underline'>hello word, tailwindcss</h1> */}
    <div className='relative'>
      ...
      <button className='absolute top-2 right-2 bg-white text-black text-xs font-bold px-2 py-1 rounded-full'>
    ...
    <div className='p-4'>
      <h3 className="text-lg font-semibold text-gray-800 line-clamp-2">
        Experience crystal-clear audio with our premium wireless headphones featuring advanced noise cancellation technology, 30-hour battery life, and comfortable over-ear design perfect for music lovers and professionals who demand exceptional sound quality in any environment.
      ...
      <div className='flex items-center mt-2'>
        ...
        <span className='ml-1 text-xs text-gray-500'>4.5(120人评论)</span>
      </div>
